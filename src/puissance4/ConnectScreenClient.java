...
// importations qui concerne le jeu et les informations nécessaires
...
// controlleur de la vue ClientController.fxml
public class ConnectScreenClient implements Initializable,ControlledScreen {
    ...
    private void btn_connect(ActionEvent event) throws MalformedURLException 
    {
        ...
        GameScreen.setInformationPlayer(player_type, pseudo);
